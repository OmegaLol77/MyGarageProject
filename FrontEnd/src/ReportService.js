...
const ADD_REPORT_REST_API_URL='http://localhost:8080/Report/addReport';
const UPDATE_REPORT_REST_API_URL='http://localhost:8080/Report/addReport';
...
DeleteReport(carNum){
    ...
    axios.delete('http://localhost:8080/Report/'+`${carNum}`+'/deleteReport').then((response)=>
    {
